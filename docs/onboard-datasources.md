...
Adding descriptions in the Aurelius Atlas is important for improving data understanding. The onboarding
process can retrieve descriptions from a schema registry if one is available. Otherwise, descriptions have
